...
from triplet_network import config, utils, metrics
from triplet_network.triplet_network import build_triplet_model

print("[INFO] loading LFW-WebFace dataset...")
if config.SAVED_DATA:
...
with mirrored_strategy.scope():
    ...
    featureExtractor = build_triplet_model(config.TL_IMG_SHAPE)
    ...
    # finally, construct the triplet network
...
print("[INFO] saving triplet model...")
